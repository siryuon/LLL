...
PATH = '/data/dataset/StandardStream/test/boolq.csv'
...
model.load_adapter('/data/moongi/lab/BART-adapter/training_output_boolq/checkpoint-942/binary_classification')
