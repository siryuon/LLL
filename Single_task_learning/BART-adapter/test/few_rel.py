...
PATH = '/data/dataset/StandardStream/test/few_rel.csv'
...
model.load_adapter('/data/moongi/lab/BART-adapter/training_output_fewrel/checkpoint-942/binary_classification')
