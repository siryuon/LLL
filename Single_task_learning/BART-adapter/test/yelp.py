...
set_seed(2022)
PATH = '/data/dataset/StandardStream/test/yelp_review.csv'
...
model.load_adapter('/data/moongi/lab/BART-adapter/sequence_training_output_udpos/checkpoint-942/binary_classification')
